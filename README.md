...
Models - папка с сохраненными моделями для корректной работы приложения

App - папка с файлами для корректной работы пользовательского приложения

Подробный план работы - файл с последовательностью действий

app.py - приложение на flask

model_Evdokimov- модель нейронной сети 
...
Для получения прогноза необходимо ввести  12 входных параметров и нажать "Готово".
